...
TTN_LEGACY_VERSIONS = {
    ...
    "ttN pipe2DETAILER": ttN_pipe_2DETAILER.version,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "ttN pipeEDIT": "pipeEDIT (Legacy)",
    "ttN pipe2BASIC": "pipe > basic_pipe (Legacy)",
    "ttN pipe2DETAILER": "pipe > detailer_pipe (Legacy)",
    ...
    "ttN pipeLoraStack": "pipeLoraStack (Legacy)",
}
